...
import com.josephwang.fragment.child.MyListMainChildFragment;
...
public class MyListMainFragment extends JParentFragment
{
    @BindView(R.id.back)
    RelativeLayout back;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        status.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                commitJChildFragment(new MyListMainChildFragment());
            }
        });
        return content;
    }
